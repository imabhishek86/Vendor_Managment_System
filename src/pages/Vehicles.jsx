        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-12 text-center flex-1 flex flex-col items-center justify-center">
            ...
            <p className="text-sm text-slate-500">
              {vehicles.length === 0 ? "You haven't added any vehicles yet." : "Try adjusting your search or filter criteria."}
            </p>
            {(searchQuery || typeFilter !== 'All' || vendorFilter !== 'All' || statusFilter !== 'All' || insuranceFilter !== 'All') ? (
              <button 
                onClick={() => {
                  setSearchQuery('');
                  setTypeFilter('All');
