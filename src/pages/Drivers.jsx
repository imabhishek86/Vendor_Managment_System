        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-12 text-center flex-1 flex flex-col items-center justify-center">
            ...
            <p className="text-sm text-slate-500">
              {drivers.length === 0 ? "You haven't added any drivers yet." : "Try adjusting your search or filter criteria."}
            </p>
            {(searchQuery || vendorFilter !== 'All' || statusFilter !== 'All' || licenseFilter !== 'All' || documentFilter !== 'All') ? (
              <button 
                onClick={() => {
                  setSearchQuery('');
                  setVendorFilter('All');
